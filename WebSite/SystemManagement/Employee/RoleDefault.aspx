...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="easyui-layout">
    <div region="west" split="true" title="角色列表" closable="false" style="width: 220px; max-width: 300px; padding: 5px;">
      <ul id="roleTree">
      </ul>
    </div>
    ...
    <div region="center">
      ...
      <table id="tbrights" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse;">
        ...
        <asp:Repeater ID="rptlist" runat="server">
          <ItemTemplate>
            <tr id="<%#Eval("id") %>">
              <th style="text-align: left; white-space: nowrap; padding: 5px">
