...
<body class="easyui-layout">
    <div region="west" title="系统菜单" split="true" border="true" iconCls="icon-favcenter" style="width: 220px; max-width: 350px;
        min-width: 150px;">
        <div id="menu_accordion" class="easyui-accordion" fit="true" border="false">        
            ...
            <div title="系统管理" iconCls="icon-tools">
            系统管理
            </div>
        </div>
    </div>
    ...
    <div region="south" style="height: 26px; background: #D2E0F2; padding: 4px 20px;
        text-align: right;">
        <input type="text" value="深 圳 天 道 数 字 工 程 有 限 公 司" style="border: 0; background-color: #D2E0F2;
            width: 220px; height: 16px" disabled="disabled" />
    </div>
</body>
</html>
