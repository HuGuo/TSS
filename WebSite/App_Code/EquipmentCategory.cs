...
public class EquipmentCategory : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (null==op) {
            ...
            context.Response.Write(TSS.BLL.EquipmentCategories.GetXml().ToString());
    ...
    void ResponseHtml(HttpContext context) 
    {
        ...
        XmlTextReader reader = new XmlTextReader(new StringReader(TSS.BLL.EquipmentCategories.GetXml().ToString()));
